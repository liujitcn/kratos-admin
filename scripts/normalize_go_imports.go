// Command normalize_go_imports normalizes explicit Go import aliases.
package main
...
func main() {
	root := flag.String("root", ".", "repository or workspace root")
	var modules stringList
	flag.Var(&modules, "module", "module directory relative to root; may be repeated")
	var files stringList
	flag.Var(&files, "file", "Go file relative to root; may be repeated")
	write := flag.Bool("write", false, "write normalized files")
	flag.Parse()
