...
/* eslint-disable */
import type { FieldDescriptorProto_Type } from "../../google/protobuf/descriptor";
...
export interface FieldRules {
  ...
  type:
    ...
    | { $case: "field_mask"; field_mask: FieldMaskRules }
...
export interface StringRules {
  ...
  well_known:
     ...
     * ```
     */
    { $case: "ip_with_prefixlen"; ip_with_prefixlen: boolean }
    | //
    /**
     ...
     * ```
     */
    { $case: "ipv4_with_prefixlen"; ipv4_with_prefixlen: boolean }
    | //
    /**
     ...
     * ```
     */
    { $case: "ipv6_with_prefixlen"; ipv6_with_prefixlen: boolean }
    | //
    /**
     ...
     * ```
     */
    { $case: "ip_prefix"; ip_prefix: boolean }
    | //
    /**
     ...
     * ```
     */
    { $case: "ipv4_prefix"; ipv4_prefix: boolean }
    | //
    /**
     ...
     * ```
     */
    { $case: "ipv6_prefix"; ipv6_prefix: boolean }
    | //
    /**
     ...
     */
    { $case: "host_and_port"; host_and_port: boolean }
    | //
    /**
     ...
     * ```
     */
    { $case: "protobuf_fqn"; protobuf_fqn: boolean }
    | //
    /**
     ...
     * ```
     */
    { $case: "protobuf_dot_fqn"; protobuf_dot_fqn: boolean }
    | //
    /**
...
export interface FieldPathElement {
  ...
  subscript:
    ...
    { $case: "bool_key"; bool_key: boolean }
    | //
    /** `int_key` specifies a map key of type int32, int64, sint32, sint64, sfixed32 or sfixed64. */
    { $case: "int_key"; int_key: number }
    | //
    /** `uint_key` specifies a map key of type uint32, uint64, fixed32 or fixed64. */
    { $case: "uint_key"; uint_key: number }
    | //
