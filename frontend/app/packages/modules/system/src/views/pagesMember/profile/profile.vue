...
import { defAuthService } from '@liujitcn/kratos-app-core/api/system/auth'
import { useUserStore } from '@liujitcn/kratos-app-core/stores'
import type { UserProfileForm } from '@liujitcn/kratos-app-core/rpc/system/app/v1/auth'
import { onLoad } from '@dcloudio/uni-app'
import { ref } from 'vue'
import type { BaseDictForm_DictItem } from '@liujitcn/kratos-app-core/rpc/system/app/v1/base_dict'
import { defBaseDictService } from '@liujitcn/kratos-app-core/api/system/base_dict'
import { formatSrc } from '@liujitcn/kratos-app-core/utils/index'
import { uploadFile } from '@liujitcn/kratos-app-core/utils/file'
import { navigateToLogin } from '@liujitcn/kratos-app-core/utils/navigation'
import defaultAvatar from '@liujitcn/kratos-app-core/static/images/avatar.png'
import navigatorBackground from '@liujitcn/kratos-app-core/static/images/navigator_bg.png'
