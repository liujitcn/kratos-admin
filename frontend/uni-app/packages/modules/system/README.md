...
`@liujitcn/kratos-uni-app-system` 是内置 system 业务模块。个人中心、个人资料、设置和 AI 能力都归属本模块，并沿用 core 的登录态、请求、导航和页面装配协议。
...
├── src
│   ├── api/base               # AI 消息、会话和工具接口
│   ├── rpc                    # system 相关 Buf 生成类型
│   ├── views
│   │   ├── pages/my           # 个人中心主页
│   │   └── pagesMember        # AI、个人资料和设置页面
