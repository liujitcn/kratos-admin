...
import { defBaseMigrationService } from "@/api/system/base_migration";
import type { BaseMigration, BaseMigrationListItem, PageBaseMigrationRequest } from "@/rpc/system/admin/v1/base_migration";
