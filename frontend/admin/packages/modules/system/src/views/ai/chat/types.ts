...
import type { AiAttachment, AiMessage, AiSession } from "@liujitcn/kratos-admin-system/rpc/base/v1/ai_session";
...
export type ChatMessageItem = AiMessage & {
  /** 当前气泡角色，由一轮消息拆分得到。 */
  role: "user" | "ai";
  /** 当前气泡正文。 */
  content: string;
