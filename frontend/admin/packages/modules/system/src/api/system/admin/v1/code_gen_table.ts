...
/** 代码生成表单的 REST JSON 请求体。 */
type CodeGenTableFormPayload = Omit<CodeGenTableForm, "i18n_config"> & {
...
export class CodeGenTableServiceImpl implements CodeGenTableService {
  ...
  CreateCodeGenTable(request: CreateCodeGenTableRequest): Promise<Empty> {
    return service<CodeGenTableFormPayload | undefined, Empty>({
      url: CODE_GEN_TABLE_URL,
      method: "post",
...
function serializeCodeGenTableForm(value?: CodeGenTableForm): CodeGenTableFormPayload | undefined {
