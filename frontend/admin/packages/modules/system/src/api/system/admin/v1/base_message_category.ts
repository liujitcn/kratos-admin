...
export class BaseMessageCategoryServiceImpl implements BaseMessageCategoryService {
  ...
  OptionBaseMessageCategory(request: OptionBaseMessageCategoryRequest): Promise<SelectOptionResponse> {
    return service<OptionBaseMessageCategoryRequest, SelectOptionResponse>({
      url: `${MESSAGE_CATEGORY_URL}/option`,
      method: "get",
      params: request
    });
  }
  ...
  PageBaseMessageCategory(request: PageBaseMessageCategoryRequest): Promise<PageBaseMessageCategoryResponse> {
    return service<PageBaseMessageCategoryRequest, PageBaseMessageCategoryResponse>({
      url: MESSAGE_CATEGORY_URL,
      method: "get",
      params: request
    });
  }
  ...
  GetBaseMessageCategory(request: GetBaseMessageCategoryRequest): Promise<BaseMessageCategoryForm> {
    return service<GetBaseMessageCategoryRequest, BaseMessageCategoryForm>({
      url: `${MESSAGE_CATEGORY_URL}/${request.id}`,
      method: "get"
    });
  }
  ...
  CreateBaseMessageCategory(request: CreateBaseMessageCategoryRequest): Promise<Empty> {
    return service<BaseMessageCategoryForm | undefined, Empty>({
      url: MESSAGE_CATEGORY_URL,
      method: "post",
      data: request.base_message_category
    });
  }
  ...
  UpdateBaseMessageCategory(request: UpdateBaseMessageCategoryRequest): Promise<Empty> {
    return service<BaseMessageCategoryForm | undefined, Empty>({
      url: `${MESSAGE_CATEGORY_URL}/${request.base_message_category?.id ?? ""}`,
      method: "put",
      data: request.base_message_category
    });
  }
  ...
  DeleteBaseMessageCategory(request: DeleteBaseMessageCategoryRequest): Promise<Empty> {
    return service<DeleteBaseMessageCategoryRequest, Empty>({ url: `${MESSAGE_CATEGORY_URL}/${request.id}`, method: "delete" });
  }

  /** 设置消息分类状态。 */
  SetBaseMessageCategoryStatus(request: SetBaseMessageCategoryStatusRequest): Promise<Empty> {
    return service<SetBaseMessageCategoryStatusRequest, Empty>({
      url: `${MESSAGE_CATEGORY_URL}/${request.id}/status`,
      method: "put",
      data: request
    });
  }
