...
} from "@liujitcn/kratos-admin-system/rpc/base/v1/ai_message";
...
export async function SendAiMessageStream(request: SendAiMessageRequest, options?: AiMessageStreamOptions): Promise<Response> {
...
export class AiMessageServiceImpl implements AiMessageService {
  ...
  /** 使用 direct stream 发送 AI 助手消息，并返回原始 Fetch Response 供调用方消费。 */
  async StreamAiMessage(request: SendAiMessageRequest, options?: AiMessageStreamOptions): Promise<Response> {
