...
```text
backend/migration/assets/v0.0.1/mysql/i18n.up.sql
backend/migration/assets/v0.0.1/mysql/i18n.description.md
```

国际化迁移脚本保留在 `v0.0.1`。迁移应：
...
12. **版本化迁移**：提交 `v0.0.1` 表结构和完整三语初始化数据，不调用在线 provider。
