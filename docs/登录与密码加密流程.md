...
本文记录管理端、uni-app 和 Taro 当前共用的账号密码、验证码、OAuth、密码密文和 Token 机制。接口以 `backend/api/proto/base/v1/login.proto`、`oauth.proto` 为准。
...
| 后端登录 | `backend/internal/biz/base/v1/login.go` |
| 后端 OAuth | `backend/internal/biz/base/v1/oauth.go` |
| 密钥生成和解密 | `backend/internal/biz/base/v1/utils/password_crypto.go` |
