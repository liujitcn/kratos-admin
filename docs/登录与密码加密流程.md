...
| 密码密钥生成与解密 | [`backend/internal/biz/base/utils/password_crypto.go`](../backend/internal/biz/base/utils/password_crypto.go) |
| 登录、验证码、账号校验、Token 签发 | [`backend/internal/biz/base/login.go`](../backend/internal/biz/base/login.go) |
| 微信 OAuth 与账号绑定 | [`backend/internal/biz/base/oauth.go`](../backend/internal/biz/base/oauth.go) |
| profile 与登录态鉴权 | [`backend/internal/biz/app/auth.go`](../backend/internal/biz/app/auth.go)、[`backend/internal/server/middleware/auth.go`](../backend/internal/server/middleware/auth.go) |
