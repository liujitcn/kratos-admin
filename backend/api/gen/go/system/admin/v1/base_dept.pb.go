...
const file_system_admin_v1_base_dept_proto_rawDesc = "" +
	...
	"\x1cbase_dept.tenant_id.required\x12\x18所属租户不能为空\x1a\bthis > 0R\btenantId\x12\x85\x01\n" +
	"\tparent_id\x18\x03 \x01(\x03Bc\xbaG\x11\x92\x02\x0e父级部门ID\xbaHL\xba\x01I\n" +
	" base_dept.parent_id.non_negative\x12\x1a上级部门不能小于 0\x1a\tthis >= 0H\x00R\bparentId\x88\x01\x01\x12\xc9\x01\n" +
	"\x04name\x18\x04 \x01(\tB\xb4\x01\xbaG\x0f\x92\x02\f部门名称\xbaH\x9e\x01\xba\x01D\n" +
	"\x17base_dept.name.required\x12\x18部门名称不能为空\x1a\x0fthis.size() > 0\xba\x01T\n" +
	"\x16base_dept.name.max_len\x12&部门名称不能超过 255 个字符\x1a\x12this.size() <= 255R\x04name\x12_\n" +
	"\x04sort\x18\x05 \x01(\x05BK\xbaG\t\x92\x02\x06排序\xbaH<\xba\x019\n" +
	"\x17base_dept.sort.required\x12\x14排序必须大于 0\x1a\bthis > 0R\x04sort\x12?\n" +
