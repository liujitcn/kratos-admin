...
func (x *BaseLog) Reset() {
	*x = BaseLog{}
	mi := &file_system_admin_v1_base_log_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BaseLog) Descriptor() ([]byte, []int) {
	return file_system_admin_v1_base_log_proto_rawDescGZIP(), []int{3}
}
...
const file_system_admin_v1_base_log_proto_rawDesc = "" +
	...
	"\f_status_code\"\x84\x01\n" +
	"\x13PageBaseLogResponse\x12I\n" +
	...
	"\n" +
	"GetBaseLog\x12\".system.admin.v1.GetBaseLogRequest\x1a\x18.system.admin.v1.BaseLog\"#\x82\xd3\xe4\x93\x02\x1d\x12\x1b/api/v1/admin/base/log/{id}B\xce\x01\n" +
...
var file_system_admin_v1_base_log_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_system_admin_v1_base_log_proto_goTypes = []any{
	(*PageBaseLogRequest)(nil),  // 0: system.admin.v1.PageBaseLogRequest
	(*PageBaseLogResponse)(nil), // 1: system.admin.v1.PageBaseLogResponse
	(*GetBaseLogRequest)(nil),   // 2: system.admin.v1.GetBaseLogRequest
	(*BaseLog)(nil),             // 3: system.admin.v1.BaseLog
}
var file_system_admin_v1_base_log_proto_depIdxs = []int32{
	3, // 0: system.admin.v1.PageBaseLogResponse.base_logs:type_name -> system.admin.v1.BaseLog
	0, // 1: system.admin.v1.BaseLogService.PageBaseLog:input_type -> system.admin.v1.PageBaseLogRequest
	2, // 2: system.admin.v1.BaseLogService.GetBaseLog:input_type -> system.admin.v1.GetBaseLogRequest
	1, // 3: system.admin.v1.BaseLogService.PageBaseLog:output_type -> system.admin.v1.PageBaseLogResponse
	3, // 4: system.admin.v1.BaseLogService.GetBaseLog:output_type -> system.admin.v1.BaseLog
...
func file_system_admin_v1_base_log_proto_init() {
	...
	file_system_admin_v1_base_log_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
