...
const file_common_v1_error_proto_rawDesc = "" +
	"\n" +
	"\x15common/v1/error.proto\x12\tcommon.v1\x1a\x13errors/errors.proto*\xb3\x01\n" +
	...
	"\x0eINTERNAL_ERROR\x10\x05\x1a\x04\xa8E\xf4\x03\x1a\x04\xa0E\xf4\x03B\xad\x01\n" +
	"\rcom.common.v1B\n" +
	"ErrorProtoP\x01ZKgithub.com/liujitcn/kratos-admin/backend/core/api/gen/go/common/v1;commonv1\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
