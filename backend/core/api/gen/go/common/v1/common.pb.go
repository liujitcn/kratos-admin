...
const file_common_v1_common_proto_rawDesc = "" +
	...
	"\bchildren\x18e \x03(\v2'.common.v1.AppTreeOptionResponse.OptionB\x12\xbaG\x0f\x92\x02\f子节点树R\bchildrenB\xae\x01\n" +
	"\rcom.common.v1B\vCommonProtoP\x01ZKgithub.com/liujitcn/kratos-admin/backend/core/api/gen/go/common/v1;commonv1\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
