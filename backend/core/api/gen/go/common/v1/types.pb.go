...
const file_common_v1_types_proto_rawDesc = "" +
	...
	"ciphertextB\xad\x01\n" +
	"\rcom.common.v1B\n" +
	"TypesProtoP\x01ZKgithub.com/liujitcn/kratos-admin/backend/core/api/gen/go/common/v1;commonv1\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
