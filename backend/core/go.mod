module github.com/liujitcn/kratos-admin/backend/core
...
require (
	...
	github.com/liujitcn/kratos-kit/auth/authn/engine/jwt v0.0.16 // indirect
	...
	github.com/liujitcn/kratos-kit/database/gorm v0.0.37 // indirect
