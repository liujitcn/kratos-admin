...
func (s *CodeGenTableService) ListCodeGenDatabaseTable(ctx context.Context, req *adminv1.ListCodeGenDatabaseTableRequest) (*adminv1.ListCodeGenDatabaseTableResponse, error) {
	res, err := s.codeGenTableCase.ListCodeGenDatabaseTable(ctx, req.GetSourceName())
	if err != nil {
