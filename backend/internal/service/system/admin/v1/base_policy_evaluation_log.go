...
type BasePolicyEvaluationLogService struct {
	...
	basePolicyEvaluationLogCase                               *biz.BasePolicyEvaluationLogCase
}

// NewBasePolicyEvaluationLogService 创建策略评估日志管理服务。
func NewBasePolicyEvaluationLogService(basePolicyEvaluationLogCase *biz.BasePolicyEvaluationLogCase) *BasePolicyEvaluationLogService {
	return &BasePolicyEvaluationLogService{basePolicyEvaluationLogCase: basePolicyEvaluationLogCase}
}
...
func (s *BasePolicyEvaluationLogService) PageBasePolicyEvaluationLog(ctx context.Context, req *adminv1.PageBasePolicyEvaluationLogRequest) (*adminv1.PageBasePolicyEvaluationLogResponse, error) {
	page, err := s.basePolicyEvaluationLogCase.PageBasePolicyEvaluationLog(ctx, req)
	if err != nil {
...
func (s *BasePolicyEvaluationLogService) GetBasePolicyEvaluationLog(ctx context.Context, req *adminv1.GetBasePolicyEvaluationLogRequest) (*adminv1.BasePolicyEvaluationLog, error) {
	item, err := s.basePolicyEvaluationLogCase.GetBasePolicyEvaluationLog(ctx, req.GetId())
	if err != nil {
