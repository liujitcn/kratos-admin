...
const (
	...
	TRANSLATION_TARGET_TYPE_BASE_CONFIG_VALUE = int32(adminv1.TranslationTargetType_TRANSLATION_TARGET_TYPE_BASE_CONFIG_VALUE)
	// TRANSLATION_TARGET_TYPE_BASE_MENU 表示菜单标题翻译。
	TRANSLATION_TARGET_TYPE_BASE_MENU = int32(adminv1.TranslationTargetType_TRANSLATION_TARGET_TYPE_BASE_MENU)
)
