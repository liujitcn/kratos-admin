...
type BaseLoginLog struct {
	...
	LoginType  int32     `gorm:"column:login_type;type:tinyint;not null;comment:登录类型" json:"login_type"`                                                                                                                                                                                                                               // 登录类型
	Result     int32     `gorm:"column:result;type:tinyint;not null;index:idx_base_login_log_result_occurred_at,priority:2;comment:结果" json:"result"`                                                                                                                                                                                  // 结果
	...
	OccurredAt time.Time `gorm:"column:occurred_at;type:datetime(3);not null;index:idx_base_login_log_ip_occurred_at,priority:2;index:idx_base_login_log_result_occurred_at,priority:3;index:idx_base_login_log_tenant_occurred_at,priority:2;index:idx_base_login_log_user_occurred_at,priority:3;comment:事件发生时间" json:"occurred_at"` // 事件发生时间
