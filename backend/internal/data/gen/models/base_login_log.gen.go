...
type BaseLoginLog struct {
	...
	Result     int32     `gorm:"column:result;type:tinyint;not null;index:idx_base_login_log_result_occurred_at,priority:2;comment:结果：枚举【BaseLogResult】" json:"result"`                                                                                                                                                                // 结果：枚举【BaseLogResult】
