...
type BaseRedactOutputPolicy struct {
	...
	Mode       int32                 `gorm:"column:mode;type:tinyint;not null;comment:处理模式：枚举【BaseRedactStoragePolicyMode】" json:"mode"`                                                                                                     // 处理模式：枚举【BaseRedactStoragePolicyMode】
	...
	Status     int32                 `gorm:"column:status;type:tinyint;not null;index:idx_base_redact_output_policy_operation,priority:2;comment:状态：枚举【Status】" json:"status"`                                                               // 状态：枚举【Status】
