...
type BasePermissionLog struct {
	...
	TargetType int32     `gorm:"column:target_type;type:tinyint;not null;index:idx_base_permission_log_target,priority:2;comment:目标类型" json:"target_type"`                                                                                                                                                                                         // 目标类型
	...
	Action     int32     `gorm:"column:action;type:tinyint;not null;index:idx_base_permission_log_action_occurred_at,priority:2;comment:权限动作" json:"action"`                                                                                                                                                                                       // 权限动作
	...
	Result     int32     `gorm:"column:result;type:tinyint;not null;comment:结果" json:"result"`                                                                                                                                                                                                                                                     // 结果
