...
type BasePermissionLog struct {
	...
	TargetType int32     `gorm:"column:target_type;type:tinyint;not null;index:idx_base_permission_log_target,priority:2;comment:目标类型：枚举【BasePermissionTargetType】" json:"target_type"`                                                                                                                                                            // 目标类型：枚举【BasePermissionTargetType】
	...
	Action     int32     `gorm:"column:action;type:tinyint;not null;index:idx_base_permission_log_action_occurred_at,priority:2;comment:权限动作：枚举【BasePermissionAction】" json:"action"`                                                                                                                                                              // 权限动作：枚举【BasePermissionAction】
	...
	OccurredAt time.Time `gorm:"column:occurred_at;type:datetime(3);not null;index:idx_base_permission_log_action_occurred_at,priority:3;index:idx_base_permission_log_target,priority:4;index:idx_base_permission_log_tenant_occurred_at,priority:2;index:idx_base_permission_log_user_occurred_at,priority:3;comment:事件发生时间" json:"occurred_at"` // 事件发生时间
