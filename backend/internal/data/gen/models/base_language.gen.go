...
type BaseLanguage struct {
	...
	Status       int32                 `gorm:"column:status;type:tinyint;not null;index:idx_base_language_status_sort,priority:1;default:1;comment:启用状态：枚举【Status】" json:"status"`          // 启用状态：枚举【Status】
