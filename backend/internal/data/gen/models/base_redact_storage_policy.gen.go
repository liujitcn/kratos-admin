...
type BaseRedactStoragePolicy struct {
	...
	DeletedAt  soft_delete.DeletedAt `gorm:"column:deleted_at;type:bigint unsigned;not null;uniqueIndex:unique_base_redact_storage_policy,priority:4;comment:删除时间;softDelete:milli" json:"deleted_at"` // 删除时间
}
