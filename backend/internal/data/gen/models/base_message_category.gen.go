...
type BaseMessageCategory struct {
	...
	DefaultPriority int32                 `gorm:"column:default_priority;type:tinyint;not null;comment:默认优先级：枚举【MessagePriority】" json:"default_priority"`                                             // 默认优先级：枚举【MessagePriority】
	...
	DeletedAt       soft_delete.DeletedAt `gorm:"column:deleted_at;type:bigint unsigned;not null;uniqueIndex:unique_base_message_category,priority:2;comment:删除时间;softDelete:milli" json:"deleted_at"` // 删除时间
}
