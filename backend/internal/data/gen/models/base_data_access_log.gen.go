...
type BaseDataAccessLog struct {
	...
	AccessType   int32     `gorm:"column:access_type;type:tinyint;not null;index:idx_base_data_access_log_access_type,priority:2;comment:访问类型" json:"access_type"`                                                                                                                                                                           // 访问类型
	...
	Sensitive    int32     `gorm:"column:sensitive;type:tinyint;not null;index:idx_base_data_access_log_sensitive,priority:2;comment:是否敏感数据" json:"sensitive"`                                                                                                                                                                               // 是否敏感数据
