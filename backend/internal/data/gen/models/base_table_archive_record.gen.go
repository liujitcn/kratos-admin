...
type BaseTableArchiveRecord struct {
	...
	SourceName       string    `gorm:"column:source_name;type:varchar(64);not null;index:idx_base_table_archive_record_source_table_status,priority:1;comment:数据源名称" json:"source_name"`                                                                               // 数据源名称
	TableName_       string    `gorm:"column:table_name;type:varchar(128);not null;index:idx_base_table_archive_record_source_table_status,priority:2;index:idx_base_table_archive_record_table_status,priority:1;comment:数据表名称" json:"table_name"`                    // 数据表名称
	...
	Status           int32     `gorm:"column:status;type:tinyint;not null;index:idx_base_table_archive_record_source_table_status,priority:3;index:idx_base_table_archive_record_table_status,priority:2;comment:归档状态：枚举【BaseTableArchiveRecordStatus】" json:"status"` // 归档状态：枚举【BaseTableArchiveRecordStatus】
