...
type BaseI18N struct {
	...
	TargetKey string `gorm:"column:target_key;type:varchar(128);not null;uniqueIndex:unique_base_i18n,priority:1;comment:翻译目标键：表名.字段名" json:"target_key"` // 翻译目标键：表名.字段名
