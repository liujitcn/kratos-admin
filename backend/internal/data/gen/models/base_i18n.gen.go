...
type BaseI18n struct {
	...
	TargetType int32  `gorm:"column:target_type;type:tinyint;not null;uniqueIndex:unique_base_i18n,priority:1;comment:目标类型：枚举【TranslationTargetType】" json:"target_type"` // 目标类型：枚举【TranslationTargetType】
