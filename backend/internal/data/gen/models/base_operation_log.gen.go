...
type BaseOperationLog struct {
	...
	Action        int32     `gorm:"column:action;type:tinyint;not null;index:idx_base_operation_log_action_occurred_at,priority:2;comment:操作动作" json:"action"`                                                                                                                                                                                      // 操作动作
	...
	OccurredAt    time.Time `gorm:"column:occurred_at;type:datetime(3);not null;index:idx_base_operation_log_action_occurred_at,priority:3;index:idx_base_operation_log_resource,priority:4;index:idx_base_operation_log_tenant_occurred_at,priority:2;index:idx_base_operation_log_user_occurred_at,priority:3;comment:事件发生时间" json:"occurred_at"` // 事件发生时间
