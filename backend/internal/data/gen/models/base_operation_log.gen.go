...
type BaseOperationLog struct {
	...
	Action        int32     `gorm:"column:action;type:tinyint;not null;index:idx_base_operation_log_action_occurred_at,priority:2;comment:操作动作：枚举【BaseOperationAction】" json:"action"`                                                                                                                                                              // 操作动作：枚举【BaseOperationAction】
