...
type BaseTableBackupRecord struct {
	...
	Status       int32     `gorm:"column:status;type:tinyint;not null;index:idx_base_table_backup_record_source_status,priority:2;comment:备份状态：枚举【BaseTableBackupRecordStatus】" json:"status"` // 备份状态：枚举【BaseTableBackupRecordStatus】
