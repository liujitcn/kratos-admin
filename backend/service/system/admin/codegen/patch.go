...
func ensureGeneratedGoImports(content string, methodContent string) string {
	imports := []struct {
		...
		{marker: "errorsx.", importLine: `"github.com/liujitcn/kratos-admin/backend/pkg/errorsx"`, importPath: "github.com/liujitcn/kratos-admin/backend/pkg/errorsx"},
		{marker: "models.", importLine: `"github.com/liujitcn/kratos-admin/backend/pkg/gen/models"`, importPath: "github.com/liujitcn/kratos-admin/backend/pkg/gen/models"},
