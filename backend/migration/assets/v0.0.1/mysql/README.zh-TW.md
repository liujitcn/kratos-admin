...
- 安全能力：登入策略選單及其服務、按鈕權限只授予平台超級管理員；線上使用者選單及下線權限授予平台管理員與租戶管理員，租戶管理員僅限本租戶。預設建立一筆全域登入策略記錄。資料脫敏選單及預設的手機號碼回應遮罩授予系統管理員。OAuth 客戶端管理選單、MFA 設定和認證方式字典直接寫入初始化資料，相關業務資料表由資料層建立。
